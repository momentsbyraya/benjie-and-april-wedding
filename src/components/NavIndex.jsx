          ...
          >
            ...
            <div 
              ref={polaroidRef}
               ...
               style={{ borderColor: '#A3B18A', transform: 'none' }}
             >
              ...
              <div className="text-center flex-1 flex flex-col items-center justify-center">
                {/* Groom's Name */}
                <div>
                  <p className="font-tebranos polaroid-text-name uppercase leading-tight" style={{ color: '#2E3B2F' }}>
                ...
                <p className="caudex-bold polaroid-text-and uppercase text-[#C2A878] leading-tight my-1">
                  AND
                </p>
                {/* Bride's Name */}
                <div>
